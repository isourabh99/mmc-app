...
import type { CustomerQuotationPostItem, PostBidItem } from "@/lib/service/alloy.api";
...
export default function QuotesPageView({
    quotationRequests,
    loadingRequests,
    onRefreshRequests,
    selectedPostForBids,
            ...
            <div className="bg-[#141518] border border-zinc-800 rounded-3xl p-5 sm:p-6 shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                    ...
                    <h2 className="text-xl sm:text-2xl font-black text-white tracking-tight">
                        {selectedPostForBids ? "Specialist Offers for Request" : "My Quotation Requests"}
                    </h2>
                    <p className="text-xs sm:text-sm text-zinc-400">
                        {selectedPostForBids
                            ? "Compare custom prices and notes sent by verified alloy wheel specialists."
                            : "Track real-time bids from mobile specialists and book the best price offer."}
                    </p>
                </div>
            ...
            {selectedPostForBids ? (
                <div className="space-y-6">
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center gap-2 text-xs">
                                ...
                                <span className="text-zinc-400 font-medium">
                                    {selectedPostForBids.car_model || "Vehicle Inspection"}
                                </span>
                            </div>
                    ...
                    {loadingPostBids ? (
                        <div className="bg-[#141518] border border-zinc-800 rounded-3xl p-16 text-center space-y-3 shadow-2xl">
                            ...
                            <p className="text-xs text-zinc-400">Loading received offers from specialists...</p>
                        </div>
                        ...
                        <div className="bg-[#141518] border border-zinc-800 rounded-3xl p-12 sm:p-16 text-center space-y-3 shadow-2xl">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-white">
                                Awaiting Specialist Bids
                            </h3>
                            <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto">
                                Quotations usually arrive within 10 to 30 minutes from nearby mobile specialists.
                                ...
                                return (
                                    ...
                                    >
                                            ...
                                            <div className="flex items-center gap-3.5">
                                                <div className="w-14 h-14 rounded-2xl bg-black border border-zinc-800 flex items-center justify-center shrink-0 p-1">
                                                    {bid.provider?.logo_full_path ? (
                                                        ...
                                                        <span className="text-base font-extrabold text-[#E8AF66]">
                                                            {bid.provider?.company_name?.slice(0, 2).toUpperCase() || "SP"}
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div>
                                                    <h4 className="text-base font-extrabold text-white capitalize">
                                                        {bid.provider?.company_name || "Alloy Specialist"}
                                                    </h4>
                                                    <div className="text-xs text-zinc-400 mt-0.5">
                                                        Contact: <strong className="text-zinc-200">{bid.provider?.contact_person_name || "Technician"}</strong> • {bid.provider?.company_phone}
                                                    </div>
                                        ...
                                        <div className="flex items-center justify-end pt-1">
                                            ...
                                            >
                                                <span>Book This Offer ({priceFormatted})</span>
                ...
                <div className="space-y-4">
                    {loadingRequests && sortedRequests.length === 0 ? (
                        <div className="bg-[#141518] border border-zinc-800 rounded-3xl p-16 text-center space-y-3 shadow-2xl">
                            <div className="w-10 h-10 border-2 border-[#E8AF66] border-t-transparent rounded-full animate-spin mx-auto" />
                            <p className="text-xs text-zinc-400">Loading your requested quotations...</p>
                        </div>
                        ...
                        <div className="bg-[#141518] border border-zinc-800 rounded-3xl p-12 sm:p-16 text-center space-y-4 shadow-2xl">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto">
                                    You have not sent any quotation requests yet. Search technicians with your vehicle reg to request instant competitive quotes.
                                </p>
                            </div>
                            <button
                                type="button"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
                                        <div className="bg-[#191A1E] rounded-2xl p-3 border border-zinc-800/80 space-y-0.5">
                                            ...
                                            <div className="text-zinc-200 font-semibold truncate">
                                                {item.service_description || "Alloy Wheel Refurbishment"}
                                            </div>
                                        </div>
                                        <div className="bg-[#191A1E] rounded-2xl p-3 border border-zinc-800/80 space-y-0.5">
                                        ...
                                        <div className="bg-[#191A1E] rounded-2xl p-3 border border-zinc-800/80 space-y-0.5">
                                            <div className="text-zinc-500 uppercase font-bold text-[10px]">Specialist Offers</div>
