    ...
    const handleQuoteSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (results && results.length > 0) {
                ...
                showToast(
                    `Found ${results.length} verified technicians near you! Select providers to send quote request.`,
                    "success"
                );
            } else {
                setSelectedProviderIdsForQuote([]);
                showToast("No technicians currently found in this area for the selected services.", "info");
            }
        } catch (err) {
